...
public class CustomerService {
    ...
    private void AddNewCustomer() {
        ...
        // BUG 1 FIX: Changed > to >= so queue cannot exceed max size
    ...
    private void ServeCustomer() {
        // BUG 2 FIX: Added check for empty queue to prevent crash
        if (_queue.Count <= 0) {
            Console.WriteLine("No Customers in the queue.");
            return;
        }
        // BUG 3 FIX: Read customer first BEFORE removing from the queue
