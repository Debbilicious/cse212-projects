public class Translator
{
    ...
    {
        _words[fromWord] = toWord; // Add or update the translation in the dictionary
    }
...
{
    return translation; // Return the translation if it exists
}
else
{
    return "???"; // Return ??? if no translation is found
}
    }
}